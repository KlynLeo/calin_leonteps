...
#Pentru a crește șansele de a găsi o tăietură de cardinal cât mai mare,
#putem folosi o strategie bazată pe multiple iterații ale algoritmului randomizat
#și selecția celei mai bune soluții găsite. Ideea este de a repeta procesul 
#de partiționare de mai multe ori și de a păstra tăietura cu cel mai mare cardinal.

# Funcție pentru a găsi tăietura de cardinal maxim prin multiple iterații
